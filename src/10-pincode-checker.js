...
export function getDataType(value) {
  ...
  if(typeof value === "object" && value === [] ||Array.isArray(value))return "array" ;
...
export function isValidParcelWeight(weight) {
  // Your code here
  if(Number.isNaN(weight) || weight === Infinity ||  typeof weight !== "number" ||weight <= 0)return false;
...
export function isWholeNumber(value) {
  // Your code here
if( Number.isNaN(value) || typeof value !== "number" || typeof value === "string"|| !Number.isInteger(value))return false;
const validNumber = Number.isInteger(value);
return validNumber;  
}
